...
curpath=$(pwd)
upath=/opt/APP/Utilities
upath_dpdk=/opt/APP/Utilities/DPDK
#upath_lib=/opt/APP/Utilities/Libvirt
#upath_qemu=/opt/APP/Utilities/QEMU
#upath_ovs=/opt/APP/Utilities/OVS
dpath=/opt/APP/Drivers
